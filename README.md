...
2. Build webpack in the privacyidea directory: ``npm run build``. Note: Install node and npm first. Check your node and npm version to fulfill the requirements.
